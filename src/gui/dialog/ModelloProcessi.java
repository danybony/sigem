...
public class ModelloProcessi extends AbstractTableModel {
        ...
        public ModelloProcessi(Object[][] table, int nColonne) {
            nomiColonna = new String[] {"Nome", "Tempo di arrivo", "Tempo di esecuzione","Associazione" };
            contenutiRighe=new Object[table.length][nColonne];
