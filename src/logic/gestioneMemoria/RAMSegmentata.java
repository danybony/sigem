...
public class RAMSegmentata extends MemoriaSegmentata{
    ...
    /**
     * Metodo che elimina i segmenti non pi� riferiti perch� il relativo processo
    ...
    public void liberaMemoria(int idProcesso){
        ...
        for(int i=0;i<memoria.size()-1;i++) {
            ...
            /**Controllo se il segmento referenziato � uno spazio oppure un
             * segmento da eliminare*/
            if(segAux1.getIndirizzo().equals("spazio") || segAux1.getIdProcesso()==idProcesso){
                
                /**Controllo se il segmento successivo � dello stesso tipo*/
                if(segAux2.getIndirizzo().equals("spazio") || segAux2.getIdProcesso()==idProcesso){
                    ...
                    /**Il segmento successivo � ancora referenziato da qualche
                     * processo. Converto a spazio il segmento corrente nel caso
                     * in cui non sia pi� referenziato da nessun processo*/
    ...
    /**
     * Metodo che restituisce il segmento con lo spazio libero pi� grande.
     * Utile per gli algoritmi di rimpiazzo dei segmenti.
     * 
     * @return
     *      Un riferimento allo spazio libero contiguo pi� grande disponibile
     *      in RAM
     */
    ...
    /**
     * Metodo che cerca se il segmento richiesto � gi� presente in RAM
     * 
     * @param seg
     *      Riferimento al segmento da controllare
     * 
     * @return
     *      TRUE se il segmento � in RAM, FALSE altrimenti
     */
    @Override
