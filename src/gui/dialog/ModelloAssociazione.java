 ...
 */
public class ModelloAssociazione extends AbstractTableModel {
        private String[] nomiColonna=new String[0];
        
        private Object[][] contenutiRighe=new Object[0][0];
        
        public ModelloAssociazione(Object[][] table) {
            nomiColonna = new String[] {"Nome", "Tempo di arrivo", "Tempo di esecuzione","Associazione Pagina" };
