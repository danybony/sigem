...
public class ViewGraficoTempiSliceSwitch  extends JScrollPane {
    public void aggiorna(XYSeries serie1, XYSeries serie2){
        ...
        JFreeChart chart = new JFreeChart("Tempi di context-switch", JFreeChart.DEFAULT_TITLE_FONT, plot, false); 
        ...
        JFreeChart chart2 = new JFreeChart("Tempi di time slice", JFreeChart.DEFAULT_TITLE_FONT, plot2, false); 
