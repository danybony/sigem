        ...
        for(int i=0;i<cambiamentiInMemoria.size(); i++){
            ...
            switch(azione.getAzione()){
                       ...
                       if(pag_seg==true){
                           ...
                           if(posizione<pagineSquare.size()){
                               ...
                               if(aux.getText().equals(" ")){
                                   ...
                                   //Il segmento successivo � uno spazio; lo connetto al segmento corrente
                                   altezza+=aux.getAltezza();
                                   pagineSquare.remove(posizione);
                           ...
                           if(posizione>0){
                               ...
                               if(aux.getText().equals(" ")){
                                   ...
                                   //Il segmento precedente � uno spazio; lo connetto al segmento corrente
                                   altezza+=aux.getAltezza();
                                   coordX=aux.getxCoord();
                                   coordY=aux.getyCoord();
                ...
                case 6:
                       ...
                       //Dopodich�, se la memoria � composta da segmenti, compatto i segmenti
                       //spazio contigui:
                       if(pag_seg==true){
                       ...
                       break;
                default:
                       //Non faccio nulla, non � un'azione rilevante
